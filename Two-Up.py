...
class TwoUp(EasyFrame):
    def __init__(self):
        ...
        self.guessField = self.addTextField(text="", row=2, column=0, sticky=E + W)
        self.addButton(text="Check guess",
                       row=3, column=0,
                       command=self.check_guess_handler)
        # Having issues centering the text fields with the row and column counts. Had to stretch with E + W
        self.outputField1 = self.addTextField(text="", row=4, column=0, sticky=E + W)
        # Having issues centering the text fields with the row and column counts. Had to stretch with E + W
        self.outputField2 = self.addTextField(text="", row=5, column=0, sticky=E + W)
        # Having issues centering the text fields with the row and column counts. Had to stretch with E + W
        self.outputField3 = self.addTextField(text="", row=6, column=0, sticky=E + W)
